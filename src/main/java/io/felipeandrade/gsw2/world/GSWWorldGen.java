...
public class GSWWorldGen {
    ...
    private static final RangeDecoratorConfig SILVER_RANGE = new RangeDecoratorConfig(16, 10, 10, 40);
    private static final RangeDecoratorConfig TITANIUM_RANGE = new RangeDecoratorConfig(1, 3, 3, 15);
    private static final RangeDecoratorConfig PLATINUM_RANGE = new RangeDecoratorConfig(1, 3, 3, 15);
